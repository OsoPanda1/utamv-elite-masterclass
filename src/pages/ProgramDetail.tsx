...
const programsData: Record<string, any> = {
  ...
  'master-ia-empresarial': {
    ...
    modality: '100% en línea',
    level: 'Avanzado',
    description: 'Programa especializado en la aplicación de inteligencia artificial en entornos empresariales. Aprende a implementar soluciones de IA generativa, machine learning y automatización para optimizar procesos, tomar decisiones basadas en datos y crear valor competitivo.',
    objectives: [
    ...
    methodology: 'Evaluación por módulo mediante exámenes de opción múltiple, ejercicios prácticos y proyecto final. Criterio de aprobación: 70% en cada módulo y entrega satisfactoria del proyecto.',
    ...
    certification: 'Certificado UTAMV de Máster Profesional en Inteligencia Artificial para Negocios. Incluye horas acreditadas, competencias desarrolladas y sello digital verificable.',
  },
  'master-transformacion-digital': {
    ...
    modality: '100% en línea',
    level: 'Avanzado',
    description: 'Programa de liderazgo en transformación digital que combina estrategia, cultura y tecnología. Aprende a direccionar cambios organizacionales, implementar marcos digitais y medir el impacto de la transformación.',
    objectives: [
    ...
    modules: [
      { title: 'Contexto y Drivers de la Transformación', hours: 5, description: 'Tendencias digitales, disruption y modelo de negocio digitales.' },
      { title: 'Estrategia Digital y Modelos de Negocio', hours: 6, description: 'Modelos canvas, servitización, plataforma y datos como activo.' },
      ...
      { title: 'Teck Stack para Transformación', hours: 6, description: 'Cloud, APIs, microservicios y arquitectura de referencia digital.' },
    ...
    methodology: 'Evaluación por módulo mediante ejercicios prácticos, case studies y proyecto final. Criterio de aprobación: 70% en cada módulo y entrega satisfactoria del proyecto.',
    ingressProfile: 'Directivos, gerentes o profesionales con experiencia en liderazgo o gestión de equipos.',
    egressProfile: 'Liderazgo digital capaz de diseñar y ejecutar estrategias de transformación, gestionar cambios y medir resultados.',
    certification: 'Certificado UTAMV de Máster Profesional en Transformación Digital. Incluye horas acreditadas, competencias desarrolladas y sello digital verificable.',
  },
};
