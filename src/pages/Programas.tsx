            ...
            <div className="flex gap-2 overflow-x-auto pb-2">
              {types.map(type => (
                <button
                  ...
                  className={`px-4 py-2 rounded-lg text-xs font-semibold tracking-wider whitespace-nowrap transition-colors ${
                    filterType === type
              ...
              {filtered.map((prog) => (
                ...
                >
                  ...
                  <div className="p-6">
                    ...
                    <h3 className="font-display text-lg font-bold text-foreground mt-2 mb-3 group-hover:text-silver transition-colors">
                      {prog.title}
                    </h3>
                    ...
                    <div className="mt-4 text-xs font-semibold text-silver tracking-wider group-hover:translate-x-1 transition-transform">
                      Ver ficha académica →
                    </div>
                  </div>
                </Link>
