...
import { ChevronRight, Clock, FileText, Play, Lock, ArrowLeft } from 'lucide-react';
...
const modules = [
  {
    ...
    description: 'Historia, evolución y tendencias. Rol de los metadatos en la nueva era digital. Introducción a SEO, AEO y posicionamiento estratégico.',
    image: module1,
    duration: '5 horas',
    lessons: 12,
    topics: ['Historia del marketing digital', 'Ecosistema digital 2026', 'Introducción a metadatos', 'Fundamentos de SEO']
  },
  {
    id: 2,
    ...
    duration: '6 horas',
    lessons: 15,
    topics: ['SEO técnico avanzado', 'Optimización semántica', 'IA para SEO', 'Core Web Vitals']
  },
  {
    id: 3,
    ...
    duration: '4 horas',
    lessons: 10,
    topics: ['Google Business Profile', 'SEO local avanzado', 'Estrategias multi-ubicación', 'Reviews y reputación']
  },
  {
    id: 4,
    ...
    duration: '5 horas',
    lessons: 13,
    topics: ['Schema markup', 'Open Graph', 'Arquitectura web', 'Taxonomías digitales']
  },
  {
    id: 5,
    title: 'AEO: Answer Engine Optimization',
    description: 'Posicionamiento en respuestas de IA, snippets destacados y búsquedas por voz.',
    image: module5,
    duration: '5 horas',
    lessons: 11,
    topics: ['Featured snippets', 'Voice search', 'AI answers', 'Knowledge Graph']
  },
  {
    id: 6,
    ...
    duration: '6 horas',
    lessons: 14,
    topics: ['Machine Learning marketing', 'Automatización workflows', 'Predictive analytics', 'CDP y personalización']
  },
  {
    id: 7,
    ...
    duration: '4 horas',
    lessons: 9,
    topics: ['Brand storytelling', 'Content marketing', 'Visual identity', 'Omnicanalidad']
  },
  {
    id: 8,
    ...
    duration: '5 horas',
    lessons: 12,
    topics: ['Marketing omnicanal', 'XR y metaverso', 'Social commerce', 'Experiencias inmersivas']
  },
  {
    id: 9,
    ...
    duration: '4 horas',
    lessons: 10,
    topics: ['Modelos de monetización', 'Ética digital', 'Privacy-first marketing', 'Compliance GDPR']
  },
  {
    id: 10,
    ...
    duration: '6 horas',
    lessons: 8,
    topics: ['Auditoría SEO completa', 'Estrategia integral', 'Presentación ejecutiva', 'Defensa de proyecto']
  },
];
    ...
    <div className="min-h-screen bg-background">
      ...
      <section className="py-16 bg-gradient-to-b from-background to-muted/30">
        <div className="container mx-auto px-4 text-center">
          ...
          <h1 className="section-title">10 Módulos de Élite</h1>
          <p className="section-subtitle">
            Cada módulo diseñado con los más altos estándares académicos internacionales. 
            Texto + audio narrado por IA para una experiencia inmersiva.
          </p>
        </div>
      </section>
                ...
                <div className="flex flex-col md:flex-row">
                  ...
                  <div className="flex-1 p-6">
                    ...
                    <div className={`mt-4 flex items-center gap-2 text-teal transition-all duration-300 ${
                      ...
                      <span className="text-sm font-medium">Ver contenido</span>
